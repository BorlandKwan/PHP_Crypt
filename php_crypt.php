...
class PHP_Crypt
{
    ...
    const DEFAULT_METHOD = 'AES-256-CBC'; //openssl_get_cipher_methods() 에서 확인
    const DEFAULT_PASSWORD = '@=|PASSWORD|=|비밀번호|=|秘密番號|=@'; // 비밀번호 설정
    ...
    public function __construct() 
    {
        ...
        if( empty(self::DEFAULT_PASSWORD) ) { exit('"DEFAULT_PASSWORD" Value Error'); }
    }
